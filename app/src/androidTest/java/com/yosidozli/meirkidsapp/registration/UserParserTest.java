...
public class UserParserTest {
    ...
    public void validateUser() throws Exception {
        String fullUrl = Uri.parse("http://82.80.198.104/UserValidationServiceWebGet/UserValidationService.svc/IsUserValid").buildUpon().appendPath("צוות").appendPath("מנויים").toString();
